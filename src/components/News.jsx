  ...
  loader={<Spinner/>}>
      <div className="row mx-3">
        ...
        {loading && <Spinner/>}
         ...
         {article.map((element)=>{
          return <div className="col-md-3 mb-4" key={element.link}>
           <Newsitem title={!element.title?"":element.title.slice(0,25)+" ..."} description={!element.description?"":element.description.slice(0,50)+" ..."} image={!element.image_url?"india.jpg":element.image_url} link={element.link}/>
        </div>
        })}
